...
import com.example.mobileapplication.activities.customer.CustomerGroceryMainActivity;
import com.example.mobileapplication.models.groceryRVModal;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class CustomerGroceryRVAdapter extends RecyclerView.Adapter<CustomerGroceryRVAdapter.ViewHolder> {
    ...
    public CustomerGroceryRVAdapter(ArrayList<groceryRVModal> groceryRVModalArrayList, Context context, ItemClickInterface itemClickInterface) {
    ...
    @NonNull
    @Override
    public CustomerGroceryRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.customer_grocery_rv,parent,false);
